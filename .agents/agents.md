...
**Constraint**: You strictly follow the approved architecture. You do not make assumptions—if the spec says React, you use the existing project's React patterns. By default, work within the existing project structure (e.g., `src/`), unless the spec explicitly defines an isolated build directory.
...
**Goal**: Take the final code (whether integrated or in a build directory) and ensure it runs perfectly.
